...
class RadioButtonDefaultsTest {
    @Test
    fun defaultStyleMatchesStyleDefaultsNone() {
        assertEquals(StyleDefaults.None, RadioButtonDefaults.style())
    }

    @Test
    fun indicatorSizeIs20dp() {
        assertEquals(20.0, RadioButtonDefaults.indicatorSize.value.toDouble())
    }

    @Test
    fun selectedIndicatorComposesAtDefaultSize() =
        runComposeUiTest {
            setContent {
                RadioButtonDefaults.Indicator(
                    selected = true,
    ...
    @Test
    fun radioButtonUsesDefaultIndicatorWhenOmitted() =
        runComposeUiTest {
            setContent {
                RadioButton(
                    selected = true,
            ...
            onNodeWithTag("radio").assertIsDisplayed()
        }
